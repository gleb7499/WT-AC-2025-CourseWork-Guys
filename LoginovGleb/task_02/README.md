...
Сервер покрыт unit и integration тестами с использованием Vitest и Supertest:
...
docker compose down -v         # Остановить стек и удалить тома (volumes (данные БД))
```
...
- **Frontend:** <http://localhost:8080> (порт 8080 по умолчанию)
- **Backend:** <http://localhost:3000>
