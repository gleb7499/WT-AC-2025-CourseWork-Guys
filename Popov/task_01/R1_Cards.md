...
## 8. Как пользователь я хочу получать уведомления о моих бронированиях

**Описание**: Система отправляет напоминания за час до начала бронирования (бонус).
...
- reason: string, не пустое при отмене администратором → ошибка: «Укажите причину отмены.»

---

## 10. Как пользователь я хочу экспортировать расписание в календарь (бонус)
