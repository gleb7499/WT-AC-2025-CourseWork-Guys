...
import { useCreateUserServices } from './create-user-modal.services'
import { createUserFormFields } from './create-user-modal.constants'
...
export const CreateUserModal = ({ open, onClose, onSuccess }: IProps) => {
    const thisService = useCreateUserServices({ onSuccess })
                    ...
                    >
                        <Field className={clsx('form-field', thisService.errors.name && 'error')}>
                            ...
                            <Input
                                ...
                                {...thisService.register(
                                    createUserFormFields.name.fieldName,
                                    createUserFormFields.name.validationOptions
                                )}
                            />
                        ...
                        <Field className={clsx('form-field', thisService.errors.email && 'error')}>
                            ...
                            <Input
                                className="form-field-input"
                                {...thisService.register(
                                    createUserFormFields.email.fieldName,
                                    createUserFormFields.email.validationOptions
                                )}
                            />
                            <Description className="form-field-error">
                        ...
                        >
                            ...
                            <Input
                                className="form-field-input"
                                {...thisService.register(
                                    createUserFormFields.password.fieldName,
                                    createUserFormFields.password.validationOptions
                                )}
                            />
                            <Description className="form-field-error">
